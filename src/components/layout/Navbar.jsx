    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        ...
        <div className="leading-none cursor-pointer">
          ...
          <h1 className="font-serif text-2xl text-[#3E3028]">
            by Shweta
          </h1>
        </div>

        {/* Desktop Menu */}
        <nav className="hidden lg:flex gap-8 text-sm font-medium text-[#493830]">
          {links.map((item) => (
            <a
              href="#"
              key={item}
        ...
        <div className="hidden lg:flex items-center gap-4">
          ...
          <button className="login-btn bg-[#D98B9F] hover:bg-[#C77289] transition-all duration-300 shadow-md">
  Join Free
</button>
        ...
        {/* Mobile Menu Button */}
        <button
          className="lg:hidden text-[#493830]"
      ...
      {/* Mobile Drawer */}
      {open && (
        <div className="lg:hidden bg-white border-t mt-4 px-6 py-5 space-y-4 shadow-md">

          {links.map((item) => (
            <a
              href="#"
              key={item}
              className="block text-[#493830] hover:text-rose-500"
            >
              {item}
            </a>
          ))}

          <button className="login-btn w-full mt-2">
            Login
          </button>
